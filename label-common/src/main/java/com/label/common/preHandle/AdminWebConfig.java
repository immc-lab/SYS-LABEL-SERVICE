...
//       如果有静态资源的时候可以在这个地方放行
                ...
                .excludePathPatterns("/sms/core/sendMailMessage","/admin/core/register","/label/core/getMusicLabelList","/label/core/saveOrSubmitLabelData","/label/core/getSaveEditData","/project/core/saveProjectData");
    }
}
